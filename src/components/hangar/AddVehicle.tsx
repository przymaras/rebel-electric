    ...
    <>
      ...
      selectedCategory[VEHICLE_TYPE] === MONSTEREBIKE_TYPE ? (
        ...
        <p className={styles.formInfo}>
          Wybierz kategorię pojazdu, aby wyświetić odpowiedni formularz
          dodawania.
        </p>
      ) : (
        <p className={styles.formInfo}>
          Formularz dodawania pojazdu dla tej kategorii jest jeszcze w trakcie
          przygotowania. W tej chwili nie jest możliwe dodanie pojazdu do tej
          kategorii. Przepraszamy za utrudnienia i zapraszamy ponownie w
          przyszłośći. Załoga Rebelelectric.com
        </p>
      )}
    </>
  );
